...
create_standard_figures <- function(data, codes, codes_participant_conditions_exp1, codes_participant_conditions_exp2) {
  ...
  ########################################
  ### Time Through Maze (Bar + Points) ### Exp 1
  ########################################
  
  data <- data_exp1
  
  
  # calculate the mean and standard deviation and standard error for each condition
